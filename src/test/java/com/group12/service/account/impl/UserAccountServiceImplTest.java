...
public class UserAccountServiceImplTest {
    ...
    public void a_create() {
        try {
            ...
            Assert.assertEquals(userAccount.getUserId(), newUserAccount.getUserId());
    ...
    public void b_read() {
        try {
            ...
            UserAccount read = service.read(userAccount.getUserId());
    ...
    public void d_delete() {
        try {
            boolean deleted = service.delete(userAccount.getUserId());
    ...
    public void f_registerUserAccount_success()
    {
        try {
            // Register a new user
            UserAccount newUser = service.registerUserAccount("rachael@cput.ac.za", "rachael@cput.ac.za", "12345678rR1@!", "12345678rR1@!");
    ...
    public void g_registerUserAccount_invalidPassword()
    {
        try {
            ...
            service.registerUserAccount("rachael@cput.ac.za", "rachael@cput.ac.za", "1234", "1234");
        }catch (Exception e)
        {

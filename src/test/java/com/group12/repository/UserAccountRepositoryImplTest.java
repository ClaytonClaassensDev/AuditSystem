...
public class UserAccountRepositoryImplTest {
    ...
    private static UserAccountRepository userAccountInformation = UserAccountRepositoryImpl.getInstance();
    ...
    public void a_create() {
        try {
            ...
            UserAccount created = userAccountInformation.create(userAccount);
    ...
    public void b_read() {
        try{
            UserAccount read = userAccountInformation.read(userAccount.getUserId());
    ...
    public void c_update() {
        ...
        updated = userAccountInformation.update(updated);
    ...
    public void e_delete() {
        try {
            //
            boolean deleted = userAccountInformation.delete(userAccount.getUserId());
    ...
    public void d_getAll() {
            System.out.println("All information from user account is as follows: " + userAccountInformation.getAll());
    }

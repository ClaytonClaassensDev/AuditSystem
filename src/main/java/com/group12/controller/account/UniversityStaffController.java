...
@RestController
@RequestMapping("/universityStaff") // class will be listening to requests through this path
public class UniversityStaffController {
    ...
    public UniversityStaff create(@RequestBody UniversityStaff universityStaff){
        UniversityStaff creatingNewUniversityStaff = UniversityStaffFactory.createUniversityStaff(universityStaff.getUniversityStaffFirstName(), universityStaff.getUniversityStaffSurname(), universityStaff.getUniversityStaffCellPhone());
